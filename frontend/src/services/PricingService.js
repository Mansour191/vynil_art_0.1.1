...
class PricingService extends BaseService {
  ...
  async getProductPricing(productId, params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/products/${productId}/pricing`, {
        method: 'GET',
        params
      });
      return {
  ...
  async getBulkProductPricing(productIds, params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/products/bulk-pricing`, {
        method: 'POST',
        body: JSON.stringify({ productIds, ...params })
      });
      return {
        success: true,
        data: response.data || response,
  ...
  async getDynamicPricingRules(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/dynamic/rules`, {
        method: 'GET',
        params
      });
      return {
  ...
  async calculateDynamicPrice(productId, context = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/dynamic/calculate`, {
        method: 'POST',
  ...
  async getPriceOptimization(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/optimization`, {
        method: 'GET',
        params
      });
      return {
  ...
  async runPriceOptimization(optimizationRequest) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/optimization/run`, {
        method: 'POST',
  ...
  async getOptimizationHistory(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/optimization/history`, {
        method: 'GET',
        params
      });
      return {
  ...
  async createPriceTest(testData) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/tests`, {
        method: 'POST',
  ...
  async getPriceTest(testId) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/tests/${testId}`, {
        method: 'GET'
      });
      return {
        success: true,
  ...
  async runPriceSimulation(simulationData) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/simulation`, {
        method: 'POST',
  ...
  async updateCustomerSegmentPricing(segmentId, pricingData) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/segments/${segmentId}/pricing`, {
        method: 'PUT',
        body: JSON.stringify(pricingData)
      });
      return {
  ...
  async getPersonalizedPrice(customerId, productId, context = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/personalized`, {
        method: 'POST',
        body: JSON.stringify({ customerId, productId, context })
      });
      return {
        success: true,
        data: response.data || response,
  ...
  async getCompetitorPricing(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/competitors`, {
        method: 'GET',
        params
      });
      return {
  ...
  async updateCompetitorPricing(competitorId, pricingData) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/competitors/${competitorId}`, {
        method: 'PUT',
        body: JSON.stringify(pricingData)
      });
      return {
  ...
  async getPricingInsights(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/insights`, {
        method: 'GET',
        params
      });
      return {
  ...
  async getPricingTrends(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/trends`, {
        method: 'GET',
        params
      });
      return {
  ...
  async getPricingStrategies(params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/strategies`, {
        method: 'GET',
        params
      });
      return {
  ...
  async applyPricingStrategy(strategyId, params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/strategies/${strategyId}/apply`, {
        method: 'POST',
  ...
  async generatePricingReport(reportType, params = {}) {
    try {
      const response = await this.apiRequest(`${this.endpoint}/reports/${reportType}`, {
        method: 'POST',
        body: JSON.stringify(params)
      });
      return {
